  ...
  options: [
    {
      ...
      subtitle: 'Massively increases revolutionary fervor and worker control, but damages relations with moderate political entities and shatters the ruling Radical-CEDA coalition.',
      subtitleZh: '大幅提高革命热情与工人控制度，但会对与温和派政治各方的关系造成损害，并使执政的激进党-CEDA联盟瓦解。',
      effect: (state) => {
    ...
    },
    {
      ...
      subtitle: 'Boosts political relations and coordinates anti-right voting, but raises dissent among purist factions and shatters the ruling coalition.',
      subtitleZh: '提升与主流左翼党派的政治协作关系，但会提升内部纯粹主义派系的不满，并使执政联盟瓦解。',
      effect: (state) => {
        let newFactions = adjustFactionDissents(state.factions, { Faistas: 10, Puristas: 10 });
    ...
    },
    {
      ...
      subtitle: 'Gains extensive support among landless peasants and shatters the ruling coalition.',
      subtitleZh: '在底层失地雇农中赢得极高的威望与动员支持，并使执政联盟瓦解。',
      effect: (state) => {
        let newClasses = state.classes;
